...
const BackdropLoader: React.FC<BackdropLoaderProps> = ({ show, children }) => {
  ...
  return (
    <div
      className="fixed top-0 right-0 h-screen z-100 flex items-center justify-center"
      style={{ width: "calc(100vw - 280px)" }}
    >
      <div className="w-full h-full bg-black/50 backdrop-blur-[6px] flex items-center justify-center">
        {children ?? (
